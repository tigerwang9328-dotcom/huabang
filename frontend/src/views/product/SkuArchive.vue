...
.sku-archive :deep(.el-table th .cell) { display:inline-flex; align-items:center; justify-content:center; gap:3px; white-space:nowrap; }
.sku-archive :deep(.el-table th .caret-wrapper) { flex:0 0 auto; height:20px; margin-left:0; }
