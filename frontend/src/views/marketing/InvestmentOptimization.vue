<template>
  <div class="investment-page command-light-page" v-loading="loading">
    <header class="page-head">
      <div>
        <p class="eyebrow">线上销售 / 投放决策</p>
        <h1>投流优化</h1>
...
<style scoped>
.investment-page{--ink:#142033;--paper:#f5f7fa;--line:#e5eaf2;--blue:#2457d6;--green:#087a55;--orange:#b55b19;--red:#b33a35;min-height:100%;padding:24px;background:var(--paper);color:var(--ink)}
.page-head{display:flex;justify-content:space-between;gap:24px;align-items:flex-end;margin-bottom:16px;padding-bottom:16px;border-bottom:1px solid var(--line)}.eyebrow,.section-label{font-size:11px;font-weight:800;letter-spacing:.08em;color:#687386}.page-head h1{font-size:28px;line-height:1.15;margin:6px 0}.subline{margin:0;color:#5d6674}.freshness{display:flex;align-items:center;gap:8px;font-size:13px}.freshness small{color:#737b86}.status-dot{width:8px;height:8px;border-radius:50%;background:var(--red)}.status-dot.online{background:var(--green)}
.decision-ledger{display:grid;grid-template-columns:1fr auto 1fr auto 1.25fr auto 1fr;align-items:stretch;margin:16px 0;border:1px solid var(--line);border-radius:8px;overflow:hidden;background:#fff;box-shadow:0 1px 2px rgba(15,23,42,.035)}.ledger-cell{padding:16px 18px;display:flex;flex-direction:column;gap:5px}.ledger-cell span{font-size:12px;color:#6d7480}.ledger-cell strong{font-size:24px;font-variant-numeric:tabular-nums}.ledger-cell em{font-style:normal;font-size:12px}.ledger-cell.verified{background:#EFF6FF;color:#1D4ED8}.ledger-cell.verified span{color:#64748B}.ledger-cell.refund{color:var(--red)}.arrow{display:grid;place-items:center;color:#98a0ab}
