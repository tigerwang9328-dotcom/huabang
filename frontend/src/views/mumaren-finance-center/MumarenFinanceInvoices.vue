  ...
  <section class="panel">
    <div class="heading">
      ...
      <div class="heading-actions">
        ...
        <el-button type="primary" :disabled="isReadonly || !bookId" @click="openCreate">登记发票</el-button>
      </div>
    </div>
    ...
    <el-table v-loading="loading" :data="invoices" empty-text="暂无发票记录" stripe show-summary :summary-method="summary">
      ...
      <el-table-column label="操作" width="160">
        <template #default="{ row }">
          <el-button :disabled="isReadonly || !canVerify(row)" link type="primary" size="small"  :loading="actingId === row.id" @click="verify(row)">认证</el-button>
