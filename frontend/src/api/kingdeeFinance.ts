...
export const kingdeeFinanceApi = {
  ...
  getAccountBalances: (params: { account_set_code: string; period: string; keyword?: string; statement_type?: string; statement_line_code?: string; page?: number; page_size?: number }) => request.get<{ data: PageResult<AccountBalance> }>("/finance/account-balances", { params }),
  getVouchers: (params: { account_set_code: string; period?: string; keyword?: string; account_code?: string; page?: number; page_size?: number }) => request.get<{ data: PageResult<VoucherListItem> }>("/finance/vouchers", { params }),
