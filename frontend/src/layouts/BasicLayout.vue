  ...
  <div class="hb-layout">
    ...
    <aside class="hb-sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        >
          <el-icon><Money /></el-icon><span>财务利润中心</span>
        </router-link>

        <div class="nav-group-label" style="margin-top:16px">运营协同</div>
        <router-link to="/member" class="nav-item" :class="{ active: activeMenu === '/member' }">
          <el-icon><User /></el-icon><span>会员运营中心</span>
        </router-link>
        <router-link to="/task" class="nav-item" :class="{ active: activeMenu.startsWith('/task') }">
          <el-icon><List /></el-icon><span>AI任务中心</span>
        </router-link>
        ...
        <router-link to="/dingtalk" class="nav-item" :class="{ active: activeMenu === '/dingtalk' }">
          <el-icon><Bell /></el-icon><span>钉钉协同</span>
        </router-link>
