...
状态：分层、状态机和通知失败隔离已自动验证；真实 VIP 唤醒任务已选定 `/app/task/1715`（会员 000344279445、门店 185805），仍需主管确认责任人后完成派发、反馈、复查、关闭并签字。
