...
| 当前可执行输入 | 当前功能分支头为 `cd47fbb110a071d58e63a8038b15d40fe84bf3df`；历史清单仍为 SHA-256 `390a3033a00e32cb03534bbf9bb01fc615c0b20c3a1131bba0532a68e4b7b195`，预期 339 张凭证、4,596 条分录。 | 本地 Git 与生产文件只读核验 | 必须以这一组输入重新执行受控 `--execute`，不能复用较早 `33d3756` 的预检结论。 |
