...
- Added `FinanceCenterService` for writing verified Kingdee DWD history into the writable `fin` ledger, including idempotent book/period/account/voucher/entry/balance creation and source links.
