...
from app.api.v1 import auth, dashboard, sync, task, finance, kingdee_finance, ai, ai_assistant, ai_diagnosis, dingtalk, system, etl, rules, report, acceptance, audit, baison, dingtalk_finance, hr, store, product, inventory, member, mobile, life_data, life_data_analysis, investment_decision
