...
class ReportService:
    ...
    async def _generate_ai_summary(self, data: dict, db: AsyncSession) -> dict:
        ...
        metrics = {
            ...
            "gross_profit": {"value": data.get("gross_profit"), "status": statuses.get("gross_profit") or cost_status, "source": "baison_cost", "as_of": stat_date},
            "gross_margin": {"value": data.get("gross_margin"), "status": gross_margin_status, "source": "baison_cost", "as_of": stat_date},
