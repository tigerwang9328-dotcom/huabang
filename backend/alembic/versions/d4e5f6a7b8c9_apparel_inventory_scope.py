"""add apparel-only inventory views
...
def downgrade():
    op.execute("DROP VIEW IF EXISTS dwd.v_apparel_inventory_snapshot")
    op.execute("DROP VIEW IF EXISTS dwd.v_apparel_inventory_balance")
